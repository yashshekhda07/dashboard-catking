...
class CEOController extends Controller
{
    ...
    public function getRevenueData()
    {
        ...
        $countData['today_day_total_revenue']['old_order'] += isset($old_previous_orders->total_revenue) ? $old_previous_orders->total_revenue : 0;
        // }
    ...
    public function getSalesData()
    {
        ...
        $data['untouched_lead_list'] = DB::table('npf_webhooks')->selectRaw('count(lead_id) as count,owner')->whereNotNull('npf_webhooks.owner')->whereBetween('urd', [$this->startDate, $this->endDate])->where('stage', 'Untouched')->groupBy('owner')->pluck('count', 'owner')->toArray();
