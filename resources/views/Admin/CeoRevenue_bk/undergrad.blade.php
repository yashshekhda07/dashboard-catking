                ...
                if (columns_basic_element) {
                    ...
                    columns_basic.setOption({
                        ...
                        xAxis: [{
                            ...
                            //],
                            data: [
                                'IPMAT Online Course - Turbo',
                                'NPAT Online Course - Turbo',
                                'CUET Online Course - Turbo',
                            ],
                            axisLabel: {
                        ...
                        series: [{
                                ...
                                // ],
                                data: [
                                    "{{ $undergrad['last_day_revenue']['ipmat-course'] }}",
                                    "{{ $undergrad['last_day_revenue']['npat-course'] }}",
                                    "{{ $undergrad['last_day_revenue']['cuet-courses'] }}"
                                ],
                                itemStyle: {
                                    normal: {
                            ...
                            },
                            {
                                ...
                                // ],
                                data: [
                                    "{{ $undergrad['today_revenue']['ipmat-course'] }}",
                                    "{{ $undergrad['today_revenue']['npat-course'] }}",
                                    "{{ $undergrad['today_revenue']['cuet-courses'] }}"
                                ],
                                itemStyle: {
                                    normal: {
                                        barBorderRadius: [4, 4, 0, 0],
                ...
                if (columns_basic_element) {
                    ...
                    columns_basic.setOption({
                        ...
                        series: [{
                                ...
                                // ],
                                data: [
                                    "{{ $undergrad['last_day_enrollment']['ipmat-course'] }}",
                                    "{{ $undergrad['last_day_enrollment']['npat-course'] }}",
                                    "{{ $undergrad['last_day_enrollment']['cuet-courses'] }}"
                                ],
                                itemStyle: {
                                    normal: {
                                        barBorderRadius: [4, 4, 0, 0],
                            ...
                            },
                            {
                                ...
                                // ],
                                data: [
                                    "{{ $undergrad['today_enrollment']['ipmat-course'] }}",
                                    "{{ $undergrad['today_enrollment']['npat-course'] }}",
                                    "{{ $undergrad['today_enrollment']['cuet-courses'] }}"
                                ],
                                itemStyle: {
                                    normal: {
                                        barBorderRadius: [4, 4, 0, 0],
    ...
    <div class="col-lg-6">
        <div class="card">
            <div class="card-header d-flex align-items-center">
                ...
                <span class="mx-3">{{ $undergrad['total_revenue']['sum'] }}</span>
                @if ($undergrad['total_revenue']['per'] > 0)
                    <span class="text-success ms-2">{{ number_format($undergrad['total_revenue']['per'], 2) }}% <i
                            class="ph-trend-up me-2"></i></span>
                @elseif($undergrad['total_revenue']['per'] < 0)
                    <span class="text-danger ms-2">{{ number_format($undergrad['total_revenue']['per'], 2) }}% <i
    ...
    <div class="col-lg-6">
        <div class="card">
            <div class="card-header d-flex align-items-center">
                ...
                <span class="mx-3">{{ $undergrad['enrollment']['count'] }}</span>
                @if ($undergrad['enrollment']['per'] > 0)
                    <span class="text-success ms-2">{{ number_format($undergrad['enrollment']['per'], 2) }}% <i
                            class="ph-trend-up me-2"></i></span>
                @elseif($undergrad['enrollment']['per'] < 0)
                    <span class="text-danger ms-2">{{ number_format($undergrad['enrollment']['per'], 2) }}% <i
                            class="ph-trend-down me-2"></i></span>
                @else
                    <span class="text-info ms-2">0.00%</span>
                @endif
