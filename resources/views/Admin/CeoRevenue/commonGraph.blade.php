                ...
                <table class="table table-hover table-bordered">
                    ...
                    <tbody>
                        <?php foreach ($commonGraph['courses_slug'] as $key => $value) { ?>
                            <tr>                                    
                                <td><?= isset($commonGraph['courses'][$value]) ? $commonGraph['courses'][$value] : ucfirst(str_replace("-", " ", str_replace("_", " ", $value))) ?></td>                                    
                                <td><?= $commonGraph['today_enrollment'][$key] ?></td>                                    
                                <td><?= numberFormat($commonGraph['today_revenue'][$key]) ?></td>
                                <td><?= $commonGraph['lastDay_enrollment'][$key] ?></td>
                                <td><?= numberFormat($commonGraph['lastDay_revenue'][$key]) ?></td>
                            </tr>
                        <?php } ?>                        
                    </tbody>
                    <tfoot>
