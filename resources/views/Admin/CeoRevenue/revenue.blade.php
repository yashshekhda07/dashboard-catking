...
<script>
                ...
                const donut_chart = c3.generate({
                    ...
                    data: {
                        columns: [
                            ...
                            ['Non-CAT', "{{ $revenue['total_no_enrollment']['non-cat'] }}"],
                            ['Study Abroad',
    ...
    }(); EchartsColumnsBasicLight.init(); barsPiesExamples.init(); $('[data-bs-popup="tooltip"]').tooltip();
        ...
        <div class="card">
            ...
            <div class="card-body pb-0">
                <div class="row text-center">
                    <div class="col-3">
                        <div class="mb-3">
                            <h3 class="mb-0">{{ numberFormat($revenue['this_year_total_enrollments']) }}</h3>
                    ...
                    <div class="col-3">
                        <div class="mb-3">
                            <h3 class="mb-0">{{ numberFormat($revenue['this_year_total_revenue']) }}</h3>
                    ...
                    <div class="col-3">
                        <div class="mb-3">
                            <h3 class="mb-0">{{ numberFormat($revenue['last_year_total_enrollments']) }}</h3>
                            <span class="text-muted fs-sm">Last Year Enrollment</span>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="mb-3">
                            <h3 class="mb-0">{{ numberFormat($revenue['last_year_total_revenue']) }}</h3>
                            <span class="text-muted fs-sm">Last Year Revenue</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="col-lg-6">
        <div class="card">
            ...
            <div class="card-body pt-0">
                ...
                <span style="width: {{ $revenue['this_year_total_enrollments_per'] }}%"
                    class="c-txt-label">{{ numberFormat($revenue['this_year_total_enrollments']) }}</span>
                ...
                <span style="width: {{ $revenue['last_year_total_enrollments_per'] }}%"
                    class="c-txt-label">{{ numberFormat($revenue['last_year_total_enrollments']) }}</span>
                <div class="progress mb-3" style="height: 1rem;">
                ...
                <span style="width: {{ $revenue['this_year_emi_enrollments_per'] }}%"
                    class="c-txt-label">{{ numberFormat($revenue['this_year_emi_enrollments']) }}</span>
                <div class="progress mb-3" style="height: 1rem;">
                    <div class="progress-bar bg-enrollment"
                ...
                <span style="width: {{ $revenue['last_year_emi_enrollments_per'] }}%"
                    class="c-txt-label">{{ numberFormat($revenue['last_year_emi_enrollments']) }}</span>
                <div class="progress mb-3" style="height: 1rem;">
                    <div class="progress-bar bg-last-revenue"
    ...
    <div class="col-lg-6">
        <div class="card">
            ...
            <div class="card-body pt-0">
                ...
                <span style="width: {{ $revenue['this_year_total_revenue_per'] }}%"
                    class="c-txt-label">{{ numberFormat($revenue['this_year_total_revenue']) }}</span>
                <div class="progress mb-3" style="height: 1rem;">
                    <div class="progress-bar bg-enrollment"
                        style="width: {{ $revenue['this_year_total_revenue_per'] }}%"
                        aria-valuenow="{{ $revenue['this_year_total_revenue_per'] }}" aria-valuemin="0"
                        aria-valuemax="100" title="{{ $revenue['this_year_total_revenue'] }}"
                        data-bs-popup="tooltip">
                        {{-- <span class="popOvertop" data-toggle="tooltip" data-placement="top"
                ...
                <span style="width: {{ $revenue['last_year_total_revenue_per'] }}%"
                    class="c-txt-label">{{ numberFormat($revenue['last_year_total_revenue']) }}</span>
                <div class="progress mb-3" style="height: 1rem;">
                    <div class="progress-bar bg-last-revenue"
                        style="width: {{ $revenue['last_year_total_revenue_per'] }}%"
                        aria-valuenow="{{ $revenue['last_year_total_revenue_per'] }}" aria-valuemin="0"
                        aria-valuemax="100" title="{{ $revenue['last_year_total_revenue'] }}"
                        data-bs-popup="tooltip">
                    </div>
                </div>
                ...
                <span style="width: {{ $revenue['this_year_emi_revenue_per'] }}%"
                    class="c-txt-label">{{ numberFormat($revenue['this_year_emi_revenue']) }}</span>
                <div class="progress mb-3" style="height: 1rem;">
                    <div class="progress-bar bg-enrollment"
                ...
                <span style="width: {{ $revenue['last_year_emi_revenue_per'] }}%"
                    class="c-txt-label">{{ numberFormat($revenue['last_year_emi_revenue']) }}</span>
                <div class="progress mb-3" style="height: 1rem;">
                    <div class="progress-bar bg-last-revenue"
    ...
    <div class="col-xl-6">
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center border-0">
                ...
                <span
                    class="badge bg-primary rounded-pill mx-2">{{ numberFormat($revenue['this_year_total_enrollments']) }}</span>
